...
import org.xtext.project.cw.myDsl.MyDslFactory;
...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @see org.xtext.project.cw.myDsl.MyDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   */
  @Override
  public EReference getModel_Screens()
  {
   ...
   */
  @Override
  public EReference getModel_StartScreen()
  {
   ...
   */
  @Override
  public EReference getScreen_Triggers()
  {
   ...
   */
  @Override
  public EReference getTrigger_Screen()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(modelEClass, MODEL__SCREENS);
    createEReference(modelEClass, MODEL__START_SCREEN);
    ...
    createEReference(screenEClass, SCREEN__TRIGGERS);

    triggerEClass = createEClass(TRIGGER);
    createEAttribute(triggerEClass, TRIGGER__TRIGGER);
    createEReference(triggerEClass, TRIGGER__SCREEN);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getModel_Screens(), this.getScreen(), null, "screens", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModel_StartScreen(), this.getScreen(), null, "startScreen", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getScreen_Triggers(), this.getTrigger(), null, "triggers", null, 0, -1, Screen.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getTrigger_Screen(), this.getScreen(), null, "screen", null, 0, 1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
